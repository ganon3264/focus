(function() {
  var STATE = { character_id: null, persona_id: null, preset_id: null, provider_id: null, provider_type: null };
  var LISTENERS = {};
  var _chatId = null;
  ...
  window.StateManager = {
    init: function(state, chatId) {
      STATE = Object.assign({ character_id: null, persona_id: null, preset_id: null, provider_id: null, provider_type: null }, state);
      _chatId = chatId || null;
