// Unit tests for reasoning-utils.js — loaded from source with DOM mocks
...
eval(fs.readFileSync(path.join(__dirname, '..', '..', 'static', 'js', 'messages', 'reasoning-utils.js'), 'utf8'));
