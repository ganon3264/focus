// Unit tests for char-editor.js — character card editor (Alpine component + functions)
...
// Load module
var src = fs.readFileSync(path.join(__dirname, '..', '..', 'static', 'js', 'features', 'char-editor.js'), 'utf8');
